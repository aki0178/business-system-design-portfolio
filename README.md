...
本リポジトリは、現職（製造業／従業員245名）でのDX推進業務を通じて
...
現職（製造業／従業員245名）でDX推進業務に携わる中で、
プログラミングを独学で習得しました。メンター不在・OJTなしの環境で、
AI（主にClaude）を協業相手として活用しながら、業務課題の発見から
設計・実装・検証までを一人で回しています。

DX推進業務としてのIT実務経験は2025/06〜2026/01の8ヶ月と短いですが、その期間で
「業務システムとして信頼に足るコードとは何か」を自分なりに突き詰めてきました。
本ポートフォリオは、その思考のプロセスと到達点を示すものです。
...
| 2025/06〜2026/01 | 現職（製造業／従業員245名）にてDX推進業務に従事。本ポートフォリオの業務ツール4本を独学で設計・実装 |
...
レビュー文化のある組織で経験を積むことで補強したいと考えています。

一方で、課題を検知して自分で修正を重ねるサイクルは、
独学期間を通じて自分の中に定着したものです。
新しい環境でも、同じやり方で伸びていけると考えています。
